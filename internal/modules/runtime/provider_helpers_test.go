...
func TestProviderRegistryAndManualProvider(t *testing.T) {
	registry := NewProviderRegistry(config.VolcengineConfig{}, config.ComfyUIBridgeConfig{}, config.OpenAICompatibleVisionConfig{}, config.OpenAICompatibleVisionConfig{}, config.MinimaxConfig{}, config.MinimaxImageConfig{}, config.KimiCodingConfig{}, config.PaiVideoConfig{})
	...
	registry = NewProviderRegistry(config.VolcengineConfig{}, config.ComfyUIBridgeConfig{Enabled: true, BaseURL: "http://127.0.0.1:8000"}, config.OpenAICompatibleVisionConfig{}, config.OpenAICompatibleVisionConfig{}, config.MinimaxConfig{}, config.MinimaxImageConfig{}, config.KimiCodingConfig{}, config.PaiVideoConfig{})
